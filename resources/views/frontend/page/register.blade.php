                        ...
                        @foreach (old('members') as $index => $member)
                            <div class="card mb-4 shadow-sm">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="mb-0">Member {{ $index + 1 }}</h4>
                                ...
                                <div class="card-body">
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="members[{{ $index }}][name]" class="form-control" placeholder="Enter name" value="{{ old('members.'.$index.'.name') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" name="members[{{ $index }}][email]" class="form-control" placeholder="Enter email" value="{{ old('members.'.$index.'.email') }}">
                                            <small class="text-danger">
                                    ...
                                    <div class="row g-2 mt-1">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="members[{{ $index }}][university]" class="form-control" placeholder="Enter university" value="{{ old('members.'.$index.'.university') }}">
                                            <small class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="members[{{ $index }}][country]" class="form-control" placeholder="Enter country" value="{{ old('members.'.$index.'.country') }}">
                                            <small class="text-danger">
                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-md-6">
                                        <label class="form-label">Name and Surname <span class="text-danger">*</span></label>
                                        <input type="text" name="members[0][name]" class="form-control" placeholder="Enter Name and Surname">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Email <span class="text-danger">*</span></label>
                                        <input type="email" name="members[0][email]" class="form-control" placeholder="Enter Email">
                                    </div>
                                </div>
                                <div class="row g-2 mt-1">
                                    <div class="col-md-6">
    ...
    <script>
        ...
        <div class="card-body">
            ...
            <div class="row g-2 mt-1">
                <div class="col-md-6">
                    <label class="form-label">University <span class="text-danger">*</span></label>
                    <input type="text" name="members[${memberIndex}][university]" class="form-control" placeholder="Enter university">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Country <span class="text-danger">*</span></label>
                    <input type="text" name="members[${memberIndex}][country]" class="form-control" placeholder="Enter country">
                </div>
            </div>
            <div class="row g-2 mt-1">
                <div class="col-md-12">
                    <label class="form-label">Transcript or Student Certificate ( PDF file | Max Size : 2MB )  <span class="text-danger">*</span></label>
                    <input type="file" name="members[${memberIndex}][file]" class="form-control">
                </div>
            </div>
        </div>
    `;
